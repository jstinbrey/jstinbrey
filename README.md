...
Status    : Learning, shipping, and improving every day
```
...
```js
const current = {
  learning: ["AI systems", "cloud computing", "model deployment"],
  building: ["smart tools", "scalable apps", "clean user experiences"],
  exploring: ["PyTorch", "AWS", "Vercel", "automation"],
  goal: "Build useful AI-powered projects and keep leveling up."
};
```
...
| Area | What I Like Building | Tools |
|---|---|---|
| AI / ML | Experiments, models, intelligent workflows | Python, PyTorch, NumPy |
| Cloud | Deployable and scalable solutions | AWS, Vercel |
| Product | Clean, usable digital experiences | Figma, Framer, Canva |
| Automation | Helpful systems that save time | GitHub, Python |
...
<img height="165" src="https://github-readme-stats.vercel.app/api?username=jstinbrey&theme=github_dark&hide_border=true&include_all_commits=true&count_private=false" alt="Justin's GitHub stats" />
<img height="165" src="https://streak-stats.demolab.com?user=jstinbrey&theme=github-dark-blue&hide_border=true" alt="Justin's GitHub streak" />

<br />

<img height="165" src="https://github-readme-stats.vercel.app/api/top-langs/?username=jstinbrey&theme=github_dark&hide_border=true&include_all_commits=true&count_private=false&layout=compact" alt="Justin's top languages" />
...
<img src="https://github-readme-activity-graph.vercel.app/graph?username=jstinbrey&theme=github-compact&hide_border=true&area=true&custom_title=Justin's%20Contribution%20Graph&color=58a6ff&line=39d353&point=ffffff&bg_color=0d1117" alt="Justin's GitHub activity graph" />
...
```py
contact = {
    "github": "github.com/jstinbrey",
    "linkedin": "linkedin.com/in/jstinbry",
    "email": "justinjpara.onbrey@gmail.com",
